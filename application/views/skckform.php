           ...
           <fieldset>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pidana_sampaimana" name="pidana_sampaimana" placeholder="Cth: Persidangan/Penyidikan Polsek">
                        </div>
                        <div class="form-group">
            ...
            <fieldset>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <hr>
                        <label for="rumussidikjari1">Rumus Sidik Jari? (Abaikan ini bila belum ada/belum mengurus di Polsek)</label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">

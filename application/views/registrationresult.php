	      ...
	      <table class="table table-bordered">
		  	...
		  	<tbody>
				<tr>
			  		...
			  		<td id="no-link-show">
				  		<p style="text-align:justify">Selamat <b><?= $skck_registration_name; ?>,</b> anda telah berhasil melakukan pendaftaran permohonan e-SKCK/SKCK Online di Polsek Pasar Kemis. Silakan <b><u>CATAT No. Aplikasi/Registrasi e-SKCK</u></b>
				  		anda: <h3 class="text-center"><b><?= $skck_registration_no; ?></b></h3><div id="qrcode"></div><br/> atau silakan <b><u>PRINT halaman ini</u></b>.
				  		Selanjutnya silakan lengkapi persyaratan yg belum ada seperti pengambilan sidik jari di Polsek, surat keterangan dari RT-RW-Kelurahan, dan sebagainya.
				  		...
				  		Silakan datang ke Polsek Pasar Kemis hari ini apabila aplikasi dibuat sebelum pukul 8.00 WIB pagi hari ini.</p>
						<blockquote>
